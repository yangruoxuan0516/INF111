import {calculerJoursRestants as calculerJoursRestantsTravail} from "./moduleTravail.js";
import {calculerJoursRestants as calculerJoursRestantsVacances} from "./moduleVacances.js";
...
t.textContent = ` Il y reste ${calculerJoursRestantsTravail(ajd).toString()} jours de travail`;
document.body.appendChild(t);

const v: HTMLHeadingElement = document.createElement("h2");
v.textContent = ` et ${calculerJoursRestantsVacances(ajd).toString()} jours de vacances dans cette année`;
